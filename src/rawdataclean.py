...
class Start:
    ...
    df = spark.read.option("delimiter", " ").csv("C:\\Users\\Sunil Kumar\\Downloads\\299999.text")
    ...
    def read_from_s3(self):
        try:
            self.df =self.spark.read.option("delimiter", " ").csv("C:\\Users\\Sunil Kumar\\Downloads\\299999.text")
            self.df.show()
    ...
    def remove_character(self):
        ...
        self.df = self.df.withColumn('request', regexp_replace('request', '%|-|\?=', ''))\
